-- =============================================================================
-- Core Tables — run this BEFORE any P0 schema files
...
CREATE INDEX idx_companies_status ON companies (subscription_status, is_active);
...
-- =============================================================================
-- 7. Permissions (global list — seeded once at deploy)
-- =============================================================================
...
-- =============================================================================
-- 9. User Roles (role assigned to user, optionally scoped to branch)
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS customers (
    ...
    phone               VARCHAR(30),
    address             TEXT,
    customer_group_id   UUID,       -- FK added after customer_groups table in P0
...
-- =============================================================================
-- 17. Sales Transactions (references pos_sessions added in P0.2)
-- =============================================================================
CREATE TABLE IF NOT EXISTS sales_transactions (
    ...
    pos_session_id      UUID,           -- FK to pos_sessions (created in P0.2)
    terminal_id         UUID,           -- FK to pos_terminals (created in P0.2)
    ...
    return_status       VARCHAR(10)     DEFAULT 'none' CHECK (return_status IN ('none','partial','full')),
